...
const uint8_t lightSensorPin1 = 2; //leftmost light sensor
const uint8_t lightSensorPin2 = 3;
const uint8_t lightSensorPin3 = 4;
const uint8_t lightSensorPin4 = 5; //rightmost light sensor
const uint8_t magneticSensorPin = 6;
const uint8_t clawServoPin = 7;
...
void setup() {
    ...
    setupOutputSensor(redLEDPin);
    setupOutputSensor(greenLEDPin);
    setupOutputSensor(blueLEDPin);
